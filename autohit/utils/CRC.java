 ...
 * <p>
 * <b>WARNING!!!!!!</b>  Any change to this code is VERY likely to
...
public class CRC {
     ...
     * @return the CRC
     */      	
    public int calc(byte[]  buf, int    off, int    len) {

        int    c = -1;      // Maybe change this later, but I'm going to assume
                            // it is held in twos-compliment form.
        
        for ( int i = off; i < off + len; i++ ) {
            c = ( c << 8 ) ^ cTable[ ( c >>> 24 ) ^ ( buf[i] & 0xff ) ];
        }
